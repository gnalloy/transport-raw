...
- 导入路径：`gnalloy.org/transport-raw`
- 仓库：`github.com/gnalloy/transport-raw`
- 默认分支：`dev`
- 预览安装：`go get gnalloy.org/transport-raw@dev`
- 许可证：Apache-2.0
...
本仓库负责：Gnalloy Raw IP 协议传输，提供 Packet 消息和显式特权运行边界。
