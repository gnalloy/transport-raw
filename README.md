...
- Import path: `gnalloy.org/transport-raw`
- Repository: `github.com/gnalloy/transport-raw`
- Default branch: `dev`
- Preview install: `go get gnalloy.org/transport-raw@dev`
- License: Apache-2.0

## Install
```bash
go get gnalloy.org/transport-raw@dev
go doc gnalloy.org/transport-raw
...
This repository owns: Raw IP protocol transport for Gnalloy with packet messages and explicit privileged runtime boundaries.
